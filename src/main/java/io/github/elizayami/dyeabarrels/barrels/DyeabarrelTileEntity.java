...
public class DyeabarrelTileEntity extends LockableLootTileEntity
{
	private NonNullList<ItemStack> inventory;
	private int viewerCount;

	private DyeabarrelTileEntity(TileEntityType<?> type)
	{
		super(type);
		this.inventory = NonNullList.withSize(27, ItemStack.EMPTY);
	}

	public DyeabarrelTileEntity()
	{
	...
	public void tick()
	{
		...
		{
			BlockState blockState = this.getBlockState();
			if (!(blockState.getBlock() instanceof DyeabarrelBlock))
			{
				this.remove();
				return;
			}
