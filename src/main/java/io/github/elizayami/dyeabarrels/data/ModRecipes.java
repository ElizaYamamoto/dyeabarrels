...
public class ModRecipes extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> consumer) 
	{
		...
		ShapelessRecipeBuilder.shapelessRecipe(BlockInit.LIGHTGRAY.barrel.get(), 1).addIngredient(TagInit.DYE_BARRELS_ITEM).addIngredient(Items.LIME_DYE).addCriterion("has_item", hasItem(Blocks.BARREL)).build(consumer, rl("light_gray_dyeabarrel_from_barrel"));
